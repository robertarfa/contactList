...
import com.example.contactlist.ContactDetail.Companion.EXTRA_CONTACT
...
class MainActivity : AppCompatActivity() ,ClickItemContactListener{
    ...
    private fun getInstanceSharedPreference():SharedPreferences{
        return  getSharedPreferences("com.example.contactlist.PREFERENCES",Context.MODE_PRIVATE)
    }
